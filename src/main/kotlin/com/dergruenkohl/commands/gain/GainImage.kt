...
class GainImage(private val gain: GraphPlayer, private val goal: Long) {
    ...
    private val category = when(gain.type){
        "" -> "weight"
        else -> gain.type
    }
    ...
    suspend fun generateGain(): Pair<MessageEmbed, BufferedImage> {
